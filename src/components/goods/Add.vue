      ...
      >
        ...
        >
          ...
          <el-tab-pane label="商品图片" name="3">
            ...
            <el-upload :action="uploadURL" list-type="picture">
...
export default {
  ...
  methods: {
    ...
    // 监听tab切换 第一个为要去的 第二个为离开的
    beforeTabLeave (activeName, oldAcativeName) {
      if (oldAcativeName === '0' && this.addForm.goods_cat.length !== 3) {
    ...
    async tabClicked () {
      ...
      if (this.activeIndex === '1') {
        ...
        console.log(dongtaishuxing.data)
    ...
    // 处理图片预览效果
    handlePreview (file) {
      this.previewPath = file.respones.data.url
      this.previewVisible = true
    },
    // 删除图片
    handleRemove (file) {
      const filePath = file.respones.data.tmp_path
